...
embedding_creator = Embeddings("TF-IDF", sentences_train, sentences_val, sentences_test)
...
embedding_creator = Embeddings("word2vec", sentences_train, sentences_val, sentences_test)
X_train, X_val, X_test = embedding_creator.train(load_model = True)

### Fit Models (more models to be added)

#### Vanilla
word2vec_embedding_layers = embedding_creator.get_embedding_layer(mean_embedding=True)
...
#### Conv 1D
word2vec_embedding_layers = embedding_creator.get_embedding_layer(mean_embedding=False)
...
### Create Embedding
embedding_creator = Embeddings("fastText", sentences_train, sentences_val, sentences_test)
X_train, X_val, X_test = embedding_creator.train(load_model = True)

### Fit Models (more models to be added)

#### Vanilla NN
fasttext_embedding_layers = embedding_creator.get_embedding_layer(mean_embedding=True)
...
### Create Embedding
embedding_creator = Embeddings("kerasEmbed", sentences_train, sentences_val, sentences_test)
X_train, X_val, X_test = embedding_creator.train(load_model = True)
